...
function NavContent({ active, onNavigate }: { active: NavKey; onNavigate?: () => void }) {
  return (
    <>
...
export default function SideNav({ active, open, onClose }: SideNavProps) {
  return (
    <>
      {/* Mobile overlay */}
      <div
      ...
      >
        <NavContent active={active} onNavigate={onClose} />
      </aside>
      {/* Desktop sidebar */}
